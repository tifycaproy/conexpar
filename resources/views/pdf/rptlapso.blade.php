     ...
     <table border="0" width="550"  cellspacing="0" cellpadding="0">
       <tr>
        ...
        <td colspan="2" align="center">
          <font size="11px"><strong>Resumen por Lapso de Beneficios Procesados<br>
          </strong></font>
        </td>		
        <td colspan="5"><font size="9px"><b>Fecha de Emision: {{date("d-m-y")}}</b></font>
        </td>
      </tr>
      <tr><td colspan="8" align="center"> <font size="8px"><b>Desde:{{ $desde}} Hasta:{{ $hasta}}</b></font></td>
...
<table table border="0" width="550"  cellspacing="0" cellpadding="0" >
  <tr>
    <td align="center" colspan="4"><p><font size="9px">Elaborado por: </font><br></p></td>
    <td align="center" colspan="4"><p><font size="9px">_________________________________ <br>{{ $firmas->nivel}} {{ $firmas->nombre}}<br>{{ $firmas->cargo}}</font></p></td>
  </tr>
</table>
